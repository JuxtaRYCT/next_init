...
DB_CONTAINER_NAME="first_next_app-postgres"
...
docker run --name $DB_CONTAINER_NAME -e POSTGRES_PASSWORD=$DB_PASSWORD -e POSTGRES_DB=first_next_app -d -p 5432:5432 docker.io/postgres
